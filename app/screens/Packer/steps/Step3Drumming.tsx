            ...
            {!recheckDone ? (
              <div>
                <div className="text-xs font-medium text-gray-600 mb-2">
                  ...
                  {!skipWeightCheck && wtStandard && (
                    <span className="text-[11px] text-gray-400 font-normal">
                      (range: {wtStandard.ref - wtStandard.tol}–{wtStandard.ref + wtStandard.tol} kg)
                    </span>
                  )}
                  {skipWeightCheck && (
                    <span className="text-[11px] text-blue-400 font-normal">(กรอกน้ำหนักแล้วบันทึกได้เลย)</span>
                  )}
                </div>
                <div className="relative">
                  <input
                    ...
                    style={{
                      borderColor: skipWeightCheck ? '#DDE2EE' : (wFail ? '#E24B4A' : wPass ? '#27500A' : '#DDE2EE'),
                      background: skipWeightCheck ? '#fff' : (wFail ? '#FCEBEB' : wPass ? '#EAF3DE' : '#fff')
                    }}
                  />
              ...
              <div className="bg-green-50 border-2 border-green-700 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-lg font-bold text-green-800">✓ Recheck PASS</div>
